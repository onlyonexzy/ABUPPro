...
;(function () {
  ...
  function renderCommTab() {
    ...
    let fieldsHtml = "";
    if (isCanBus) {
      if (ecu.frameFormat === undefined) ecu.frameFormat = "11bit";
      if (ecu.stmin === undefined) ecu.stmin = "0 ms";
      if (ecu.bs === undefined) ecu.bs = "8";
      if (ecu.p2Client_timeout === undefined) ecu.p2Client_timeout = "150 ms";
      if (ecu.p2StarClient_timeout === undefined) ecu.p2StarClient_timeout = "5100 ms";
      ...
      fieldsHtml = `
        <div class="basic-diag-comm-grid">
          ...
          <div class="basic-diag-comm-item">
            <span>帧格式</span>
            <select class="basic-diag-comm-select" data-role="bd-comm-field" data-field="frameFormat">
              <option value="11bit" ${ecu.frameFormat === "11bit" ? "selected" : ""}>11bit</option>
              <option value="29bit" ${ecu.frameFormat === "29bit" ? "selected" : ""}>29bit</option>
            </select>
          </div>
          <div class="basic-diag-comm-item">
            <span>请求地址</span>
            <input class="basic-diag-comm-input" type="text" data-role="bd-comm-field" data-field="requestAddr" value="${esc(ecu.requestAddr || ecu.nadAddr || "")}" />
          </div>
          <div class="basic-diag-comm-item">
            <span>响应地址</span>
            <input class="basic-diag-comm-input" type="text" data-role="bd-comm-field" data-field="responseAddr" value="${esc(ecu.responseAddr || "")}" />
          </div>
          <div class="basic-diag-comm-item">
            <span>功能寻址</span>
          ...
          <div class="basic-diag-comm-item">
            <span>Stmin</span>
            <input class="basic-diag-comm-input" type="text" data-role="bd-comm-field" data-field="stmin" value="${esc(ecu.stmin)}" />
          </div>
          <div class="basic-diag-comm-item">
            <span>BS</span>
          ...
          <div class="basic-diag-comm-item">
            <span>P2*Client_timeout</span>
            <input class="basic-diag-comm-input" type="text" data-role="bd-comm-field" data-field="p2StarClient_timeout" value="${esc(ecu.p2StarClient_timeout)}" />
          </div>
        </div>
      `;
    } else if (isEth) {
      ...
      if (ecu.p6Client_timeout === undefined) ecu.p6Client_timeout = "5000 ms";
      if (ecu.p6StarClient_timeout === undefined) ecu.p6StarClient_timeout = "9950 ms";
      ...
      fieldsHtml = `
        <div class="basic-diag-comm-grid">
          ...
          <div class="basic-diag-comm-item">
            <span>P6*Client_timeout</span>
            <input class="basic-diag-comm-input" type="text" data-role="bd-comm-field" data-field="p6StarClient_timeout" value="${esc(ecu.p6StarClient_timeout)}" />
          </div>
        </div>
      `;
    } else {
